...
router.post('/getsleepbydate', authTokenHandler, async (req, res) => {
    ...
    const filteredSleepEntries = filterEntriesByDate(user.sleep, targetDate);

    res.json(createResponse(true, 'Sleep entries fetched successfully', filteredSleepEntries));
});
